...
export const RegistrationPage = () => {
	...
	const registrationSlice	= useSelector((state) => state.registrationSlice);
    ...
    function handleSubmit(e) {
        ...
        if (first_name && last_name && email && password) {
			...
			if(registrationSlice && registrationSlice.registrationList && registrationSlice.registrationList.data && registrationSlice.registrationList.data.code) {
	...
	return (
		registrationSlice && registrationSlice.registrationList && registrationSlice.registrationList.data && registrationSlice.registrationList.data.data && registrationSlice.registrationList.data.data.code ?
			<Redirect to="/registration-confirmation" /> :
