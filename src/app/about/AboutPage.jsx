						...
						<Row>
							<Col md={12}>
								<div className="about-wrapper">
									...
									<p>
									<b>Lawyers Nib</b> is a full-service law firm with a specialization in Civil, Criminal, Corporate, Company, Income Tax, Property and Investment related legal practices. The law firm is one of the top law firms in Dhaka, Bangladesh and represents both foreign and local clients. The main area of Practice of the Firm in General Litigation (Civil & Criminal), Corporate Law, Commercial Documentations, Foreign Direct Investment, Labour Laws, Commercial Litigation, Tax Consultation, Property Disputes, Real Estate & Construction Adjudication. This Law Firm consists of experienced lawyers and consultants, providing one-stop solutions to the clients. The Firm also works with a number of Chartered Accountant Firms to provide Financial Consultation to the Client. <b>Lawyers Nib</b> also has a number of Business Consultant and Professional tax consultant to provide additional services including corporate tax advisory services, company registration, business licensing services, HR dispute resolution, claim settlements, etc. The lawyers working as partners, associates and paralegals of <b>Lawyers Nib</b> are highly qualified having both local and foreign qualifications and credentials. Lawyers and consultants of <b>Lawyers Nib</b>  are worth of experience and knowledge in several matters including (but not limited to) corporate matters, litigation, arbitration, land law matters, real estate matters, family law issues, labour law, writ, banking matters, business setup, admiralty, shipping, Tax Consultation, Property Disputes, Real Estate & Construction Adjudication and any kind of legal services as may be required. The law firm represents local and international companies, businesses, high net worth individuals, walk-in clients and generally clients from all walks of life. 
									<br /> <br />
									Inspired by leading international law firms, the firm is structured as a full service and diverse law firm which means that our clients can expect a one-stop service for most of their legal issues. We continue to grow our team to accommodate the needs of our clients.
									 <br /> <br /> <br />
									The firm operates under strict ethical guidelines and maintains international standards in handling its affairs. The firm strives to implement a solution oriented approach to provide fast and efficacious remedies to its clients. <b>Lawyers Nib</b> considers its clients as its biggest assets. Regardless of nationality, gender, religious beliefs or sexual orientation, our clients can expect a uniform and consistent level of service at all times.
									</p>
